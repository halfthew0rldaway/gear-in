...
@section('content')
    <section class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-16">
        <div class="grid lg:grid-cols-[1.1fr_0.9fr] gap-8 items-center scroll-reveal">
            <div class="space-y-8">
            ...
            <div class="bg-white border border-gray-200 rounded-[32px] p-8 space-y-6 scroll-reveal">
                <p class="text-xs uppercase tracking-[0.5em] text-gray-400">Kategori</p>
                <div class="flex flex-col gap-4" data-stagger="50" data-stagger-selector="> a">
        ...
        <div id="featured" class="space-y-8 scroll-reveal">
        ...
        <div class="space-y-6 scroll-reveal">
            ...
            <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3" data-stagger="100" data-stagger-selector="> div">
