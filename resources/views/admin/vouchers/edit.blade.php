...
@section('content')
    <div class="flex items-center justify-between mb-8">
        <div>
            ...
            <h1 class="text-3xl font-semibold">Edit Voucher</h1>
        </div>
    ...
    <form action="{{ route('admin.vouchers.update', $voucher) }}" method="POST" id="voucher-form">
        @csrf
        @method('PUT')
                    ...
                    <div class="space-y-6">
                        ...
                        <label class="block">
                            ...
                            <textarea name="description" rows="3"
                                class="w-full rounded-xl border border-gray-200 px-4 py-3 focus:border-gray-900 focus:ring-gray-900">{{ old('description', $voucher->description) }}</textarea>
                        </label>
                    </div>
                </div>
                ...
                <div class="bg-white border border-gray-200 rounded-[32px] p-8">
                    ...
                    <div class="space-y-6">
                        <div class="grid sm:grid-cols-2 gap-6">
                            ...
                            <label class="block">
                                <span class="text-xs font-medium text-gray-700 uppercase tracking-wide mb-2 block">Nilai
                                    Diskon</span>
                                <input type="number" name="value" id="voucher-value"
                                    value="{{ old('value', $voucher->value) }}" required min="0" step="0.01"
                                    class="w-full rounded-xl border border-gray-200 px-4 py-3 focus:border-gray-900 focus:ring-gray-900">
                        ...
                        <div id="max-discount-field"
                            class="{{ old('type', $voucher->type) === 'percentage' ? '' : 'hidden' }}">
                            <label class="block">
                        ...
                        <label class="block">
                            ...
                            <input type="number" name="min_purchase"
                                value="{{ old('min_purchase', $voucher->min_purchase) }}" min="0" step="0.01"
                                class="w-full rounded-xl border border-gray-200 px-4 py-3 focus:border-gray-900 focus:ring-gray-900">
                        </label>
                    </div>
                </div>
