...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <meta property="og:title" content="@yield('title', 'gear-in')">
        <meta property="og:description" content="@yield('description', 'gear-in - Curated gaming essentials for your setup.')">
        <meta property="og:type" content="website">
        <meta property="og:url" content="{{ url()->current() }}">
        <meta name="twitter:card" content="summary">
        <meta name="twitter:title" content="@yield('title', 'gear-in')">
        <meta name="twitter:description" content="@yield('description', 'gear-in - Curated gaming essentials for your setup.')">
